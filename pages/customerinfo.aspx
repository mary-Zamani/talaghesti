<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="customerinfo.aspx.cs" Inherits="narsShop.customerinfo"  MasterPageFile="~/mst.Master"%>
...
<h5><asp:Label ID="lbl_title" runat="server" /></h5>
          ...
          <table width="100%" >
              ...
              <tr>
                      <td><asp:TextBox TextMode="SingleLine" runat="server" ID="txt_adress" CssClass="form-control" /></td>
              </tr>
              <tr style="text-align:center">
                  <td><asp:Button ID="Btn_save"  runat="server" Text=" اصلاح " OnClick="Btn_save_Click" CssClass="btn btn-info btn-block"  /> </td>
